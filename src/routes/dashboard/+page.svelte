<script lang="ts">
  ...
  // Service Setup einzelne Bereiche
  ...
  // Projekt-Bearbeitungsfunktionen
  function editProjectSection(section: string, project: Project & { id: string }) {
    ...
    editForm.subType = project.subType || '';
    editForm.projectDetails = project.projectDetails || '';
    editForm.projectStatus = project.projectStatus || '';
    editForm.desiredDomain = project.desiredDomain || '';
    editForm.domainStatus = project.domainStatus || '';
    editForm.goals = project.goals || '';
    editForm.targetAudience = project.targetAudience || '';
    editForm.timeline = project.timeline || '';
    editForm.budget = project.budget || '';
    editForm.estimatedPrice = project.estimatedPrice || 0;
    editForm.primaryColour = project.primaryColour || '';
    editForm.secondaryColour = project.secondaryColour || '';
    editForm.accentColour = project.accentColour || '';
    editForm.desiredFont = project.desiredFont || '';
    editForm.features = project.features || [];
    editForm.customFeature = project.customFeature || '';
  }
  ...
  async function saveProjectSection() {
    if (!selectedProject || !editingSection) return;
    ...
    try {
      // Je nach Sektion die entsprechenden Daten zusammenstellen
      let updateData: Partial<Project> = { id: selectedProject.id };
      ...
      if (response.ok) {
        ...
        // Ausgewähltes Projekt aktualisieren
        selectedProject = { ...selectedProject, ...updateData };
  ...
  // Verfügbare Features (aus dem Interface)
  const availableFeatures = [
    'kontaktformular', 'bildergalerie', 'mapsIntegration', 'socialMedieIntegration',
    'newsletterRegistrierung', 'suchfunktion', 'mehrsprachigkeit', 'terminbuchung',
    'zahlungsbawicklung', 'benutzerkonten', 'analyticsIntegration', 'seo',
    'customTeaser', 'customCarousel', 'customFilter', 'megaMenu', 'kalender',
    'portfolioGrid', 'downloadbereich', 'dateiupload', 'akkordeon', 'tabs',
    'multiStepDialog', 'chatbot', 'konfigurator', 'assistent',
    'bewertungsmechanismus', 'themeSwitcher', 'cookieConsent', 'videoEmbedding',
    'barrierefreiheitTools', 'altersverifikation', 'marketingTools'
  ];

  // Kunden-Bearbeitungsfunktionen
  function editCustomer() {
    ...
    // Formular mit aktuellen Werten vorausfüllen
    customerForm.familyName = selectedProject.owner.familyName || '';
    customerForm.givenName = selectedProject.owner.givenName || '';
    customerForm.salutation = selectedProject.owner.salutation || '';
    customerForm.email = selectedProject.owner.email || '';
    customerForm.phone = selectedProject.owner.phone || '';
    customerForm.company = selectedProject.owner.company || '';
    customerForm.address = selectedProject.owner.address || '';
    customerForm.postCode = selectedProject.owner.postCode || '';
    customerForm.city = selectedProject.owner.city || '';
    customerForm.country = selectedProject.owner.country || '';
  }
  ...
  async function saveCustomer() {
    ...
    try {
      ...
      if (response.ok) {
        // Projekt in der Liste aktualisieren
        const projectIndex = projects.findIndex((p) => p.id === selectedProject.id);
        if (projectIndex !== -1 && projects[projectIndex].owner) {
          projects[projectIndex].owner = { ...projects[projectIndex].owner, ...customerForm };
        }

        // Ausgewähltes Projekt aktualisieren
        if (selectedProject.owner) {
          selectedProject.owner = { ...selectedProject.owner, ...customerForm };
        }
  ...
  // Service Setup einzelne Bereiche bearbeiten
  ...
  async function saveSetupService() {
    ...
    try {
      ...
      // Aktuelles Setup kopieren und nur den bearbeiteten Service aktualisieren
      ...
      if (response.ok) {
        ...
        const projectIndex = projects.findIndex((p) => p.id === selectedProject.id);
        if (projectIndex !== -1) {
          projects[projectIndex] = { ...projects[projectIndex], setup: updatedSetup };
        }
  ...
  // Verfügbare Projekttypen und Status
  const projectTypes = ['freestyle', 'cms', 'website', 'webApplication', 'artificialIntelligence'];
  const subTypes = [
    'onepager', 'corporateWebsite', 'corporateWebsitePremium', 'cmsSimple',
    'cmsPremium', 'blogSystem', 'headlessCms', 'pwa', 'customApp', 'eCommerce',
    'apiIntegration', 'customTool', 'onepagerPlus', 'aiConsulting',
    'aiWorkflows', 'aiAgents', 'aiIndividual'
  ];
  const statusOptions = ['created', 'introduced', 'prototype', 'refinement', 'ready', 'published', 'paid'];
  const domainStatusOptions = ['verfügbar', 'registriert', 'übertragen', 'konfiguriert', 'nicht verfügbar'];
          ...
          <div class="card-body">
            <div class="flex items-center justify-between mb-4">
              ...
              {#if editingSection !== 'grundinformationen'}
                <button class="btn btn-xs btn-simple" onclick={() => editProjectSection('grundinformationen', selectedProject)}>
            ...
            {#if editingSection === 'grundinformationen'}
              ...
              <div class="space-y-4">
                ...
                <div class="form-control">
                  ...
                  <input type="text" bind:value={editForm.name} class="input input-bordered input-sm" />
                </div>
                ...
                <div class="form-control">
                  ...
                  <select bind:value={editForm.projectType} class="select select-bordered select-sm">
                ...
                <div class="form-control">
                  ...
                  <select bind:value={editForm.subType} class="select select-bordered select-sm">
                    <option value="">Bitte wählen</option>
                ...
                <div class="form-control">
                  ...
                  <select bind:value={editForm.projectStatus} class="select select-bordered select-sm">
                    <option value="">Bitte wählen</option>
                ...
                <div class="form-control">
                  ...
                  <textarea bind:value={editForm.description} class="textarea textarea-bordered textarea-sm h-20" placeholder="Projektbeschreibung"></textarea>
                </div>
                ...
                <div class="form-control">
                  ...
                  <textarea bind:value={editForm.projectDetails} class="textarea textarea-bordered textarea-sm h-20" placeholder="Detaillierte Projektbeschreibung"></textarea>
                </div>
            ...
            {#if editingCustomer}
              ...
              <div class="space-y-4">
                ...
                <div class="form-control">
                  ...
                  <select bind:value={customerForm.salutation} class="select select-bordered select-sm">
                    <option value="">Bitte wählen</option>
                    {#each salutationOptions as salutation}
                ...
                <div class="grid grid-cols-2 gap-2">
                  <div class="form-control">
                    ...
                    <input type="text" bind:value={customerForm.givenName} class="input input-bordered input-sm" />
                  </div>
                  <div class="form-control">
                    <label class="label">
                      <span class="label-text">Nachname</span>
                    </label>
                    <input type="text" bind:value={customerForm.familyName} class="input input-bordered input-sm" />
                  </div>
                </div>
                ...
                <div class="form-control">
                  ...
                  <input type="email" bind:value={customerForm.email} class="input input-bordered input-sm" />
                </div>
                ...
                <div class="form-control">
                  ...
                  <input type="tel" bind:value={customerForm.phone} class="input input-bordered input-sm" />
                </div>
                ...
                <div class="form-control">
                  ...
                  <input type="text" bind:value={customerForm.company} class="input input-bordered input-sm" />
                </div>
                ...
                <div class="form-control">
                  ...
                  <input type="text" bind:value={customerForm.address} class="input input-bordered input-sm" />
                </div>
                ...
                <div class="grid grid-cols-2 gap-2">
                  <div class="form-control">
                    ...
                    <input type="text" bind:value={customerForm.postCode} class="input input-bordered input-sm" />
                  </div>
                  <div class="form-control">
                    <label class="label">
                      <span class="label-text">Stadt</span>
                    </label>
                    <input type="text" bind:value={customerForm.city} class="input input-bordered input-sm" />
                  </div>
                </div>
                ...
                <div class="form-control">
                  ...
                  <input type="text" bind:value={customerForm.country} class="input input-bordered input-sm" />
                </div>
          ...
          <div class="card-body">
            <div class="flex items-center justify-between mb-4">
              ...
              {#if editingSection !== 'spezifikationen'}
                <button class="btn btn-xs btn-simple" onclick={() => editProjectSection('spezifikationen', selectedProject)}>
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                  </svg>
                  Bearbeiten
            ...
            {#if editingSection === 'spezifikationen'}
              ...
              <div class="space-y-4">
                ...
                <div class="form-control">
                  ...
                  <input type="text" bind:value={editForm.desiredDomain} class="input input-bordered input-sm" placeholder="example.com" />
                </div>
                ...
                <div class="form-control">
                  ...
                  <select bind:value={editForm.domainStatus} class="select select-bordered select-sm">
                    <option value="">Bitte wählen</option>
                    {#each domainStatusOptions as status}
                ...
                <div class="form-control">
                  ...
                  <textarea bind:value={editForm.goals} class="textarea textarea-bordered textarea-sm h-20" placeholder="Projektziele beschreiben"></textarea>
                </div>
                ...
                <div class="form-control">
                  ...
                  <textarea bind:value={editForm.targetAudience} class="textarea textarea-bordered textarea-sm h-20" placeholder="Zielgruppe beschreiben"></textarea>
                </div>
                ...
                <div class="form-control">
                  ...
                  <input type="text" bind:value={editForm.timeline} class="input input-bordered input-sm" placeholder="z.B. 3 Monate" />
                </div>
          ...
          <div class="card-body">
            <div class="flex items-center justify-between mb-4">
              ...
              {#if editingSection !== 'budget'}
                <button class="btn btn-xs btn-simple" onclick={() => editProjectSection('budget', selectedProject)}>
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                  </svg>
                  Bearbeiten
            ...
            {#if editingSection === 'budget'}
              ...
              <div class="space-y-4">
                ...
                <div class="form-control">
                  ...
                  <input type="text" bind:value={editForm.budget} class="input input-bordered input-sm" placeholder="z.B. 5000" />
                </div>
                ...
                <div class="form-control">
                  ...
                  <input type="number" bind:value={editForm.estimatedPrice} class="input input-bordered input-sm" placeholder="0" />
                </div>
          ...
          <div class="card-body">
            <div class="flex items-center justify-between mb-4">
              ...
              {#if editingSection !== 'features'}
                <button class="btn btn-xs btn-simple" onclick={() => editProjectSection('features', selectedProject)}>
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                  </svg>
                  Bearbeiten
            ...
            {#if editingSection === 'features'}
              ...
              <div class="space-y-4">
                  ...
                  <div class="grid grid-cols-2 gap-2 max-h-60 overflow-y-auto">
                    {#each availableFeatures as feature}
                      <label class="label cursor-pointer justify-start">
                        ...
                        />
                        <span class="label-text text-xs">{feature}</span>
                      </label>
                    {/each}
                  </div>
                </div>
                ...
                <div class="form-control">
                  ...
                  <input type="text" bind:value={editForm.customFeature} class="input input-bordered input-sm" placeholder="Individuelles Feature" />
                </div>
          ...
          <div class="card-body">
            <div class="flex items-center justify-between mb-4">
              ...
              {#if editingSection !== 'design'}
                <button class="btn btn-xs btn-simple" onclick={() => editProjectSection('design', selectedProject)}>
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                  </svg>
                  Bearbeiten
              ...
              <div class="space-y-4">
                ...
                <div class="form-control">
                  ...
                  <div class="flex items-center gap-2">
                    <input type="color" bind:value={editForm.primaryColour} class="w-12 h-8 rounded border border-base-300" />
                    <input type="text" bind:value={editForm.primaryColour} class="input input-bordered input-sm flex-1" placeholder="#000000" />
                  </div>
                </div>
                ...
                <div class="form-control">
                  ...
                  <div class="flex items-center gap-2">
                    <input type="color" bind:value={editForm.secondaryColour} class="w-12 h-8 rounded border border-base-300" />
                    <input type="text" bind:value={editForm.secondaryColour} class="input input-bordered input-sm flex-1" placeholder="#000000" />
                  </div>
                </div>
                ...
                <div class="form-control">
                  ...
                  <div class="flex items-center gap-2">
                    <input type="color" bind:value={editForm.accentColour} class="w-12 h-8 rounded border border-base-300" />
                    <input type="text" bind:value={editForm.accentColour} class="input input-bordered input-sm flex-1" placeholder="#000000" />
                  </div>
                </div>
                ...
                <div class="form-control">
                  ...
                  <input type="text" bind:value={editForm.desiredFont} class="input input-bordered input-sm" placeholder="z.B. Arial, Helvetica" />
                </div>
                ...
                {#if editingSetupService === 'github'}
                  ...
                  <div class="space-y-3">
                    ...
                    <div class="form-control">
                      ...
                      <input type="text" bind:value={serviceForm.username} class="input input-bordered input-xs" placeholder="GitHub Username" />
                    </div>
                    ...
                    <div class="form-control">
                      ...
                      <input type="password" bind:value={serviceForm.password} class="input input-bordered input-xs" placeholder="GitHub Passwort" />
                    </div>
                    ...
                    <div class="form-control">
                      ...
                      <textarea bind:value={serviceForm.authTokens} class="textarea textarea-bordered textarea-xs h-16 font-mono text-xs" placeholder="Token"></textarea>
                    </div>

                    <div class="form-control">
                      <label class="label cursor-pointer">
                        <span class="label-text text-xs">Konfiguriert</span>
                        <input type="checkbox" bind:checked={serviceForm.isConfigured} class="checkbox checkbox-xs checkbox-primary" />
                      </label>
                    </div>
                ...
                {#if editingSetupService === 'netlify'}
                  ...
                  <div class="space-y-3">
                    ...
                    <div class="form-control">
                      ...
                      <input type="text" bind:value={serviceForm.username} class="input input-bordered input-xs" placeholder="Netlify Username" />
                    </div>
                    ...
                    <div class="form-control">
                      ...
                      <input type="password" bind:value={serviceForm.password} class="input input-bordered input-xs" placeholder="Netlify Passwort" />
                    </div>
                ...
                {#if editingSetupService === 'hygraph'}
                  ...
                  <div class="space-y-3">
                    ...
                    <div class="form-control">
                      ...
                      <input type="text" bind:value={serviceForm.username} class="input input-bordered input-xs" placeholder="Hygraph Username" />
                    </div>
                    ...
                    <div class="form-control">
                      ...
                      <input type="password" bind:value={serviceForm.password} class="input input-bordered input-xs" placeholder="Hygraph Passwort" />
                    </div>
                ...
                {#if editingSetupService === 'auth0'}
                  ...
                  <div class="space-y-3">
                    ...
                    <div class="form-control">
                      ...
                      <input type="text" bind:value={serviceForm.username} class="input input-bordered input-xs" placeholder="Auth0 Username" />
                    </div>
                    ...
                    <div class="form-control">
                      ...
                      <input type="password" bind:value={serviceForm.password} class="input input-bordered input-xs" placeholder="Auth0 Passwort" />
                    </div>
