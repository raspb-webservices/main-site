...
<div class="content-area impressum">
  <Section>
    <h1>Impressum</h1>

    <h2>Angaben gemäß § 5 TMG</h2>
    <div class="contact-info">
      <p><strong>raspb Webservices UG (in Gründung)</strong></p>
    ...
    <div class="contact-details">
      <p><strong>Telefon:</strong> 06732 - 9648113</p>
...
<style lang="postcss">
  ...
  .impressum-content h2 {
    @apply text-primary mt-8 mb-4 text-2xl font-bold;
  }

  .impressum-content h3 {
    @apply text-secondary mt-6 mb-3 text-xl font-semibold;
  }

  .impressum-content p {
    @apply mb-3 text-base leading-relaxed;
  }
