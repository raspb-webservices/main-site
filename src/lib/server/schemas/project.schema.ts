...
const projectTypeEnum = z.enum([
	'website', 'app', 'aiSolution', 'freestyle'
]);

const subTypeEnum = z.enum([
	'onepager', 'onepagerPlus', 'corporateWebsite', 'corporateWebsitePlus',
	'cms', 'cmsPlus', 'webApp', 'pwaSimple', 'pwaExtended',
	'individualApp', 'aiConsulting', 'agenticAi', 'generativeAi',
	'bots', 'workflowAutomation', 'aiWorkflows', 'individualAi'
]);

const featuresEnum = z.enum([
	'contactForm', 'newsletterRegistration', 'chatbot', 'voicebot',
	'appointments', 'imageGallery', 'videoEmbedding', 'portfolioGrid',
	'calendar', 'fileUpload', 'megaMenu', 'customTeaser', 'customCarousel',
	'accordeon', 'tabs', 'themeSwitcher', 'search', 'customFilter',
	'multiStepDialog', 'configurator', 'assistant', 'rating', 'payment',
	'userAccounts', 'ageVerification', 'cookieConsent', 'accessibility',
	'mapsIntegration', 'socialMediaIntegration', 'analyticsIntegration',
	'seo', 'marketingTools', 'localization', 'virtualTour'
]);
