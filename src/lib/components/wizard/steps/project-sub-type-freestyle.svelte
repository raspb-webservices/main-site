<script lang="ts">
  ...
  import { projectSubTypesFreestyle } from '$lib/configs/wizard-config';
...
<div class="step-header">
  <h1>
    {m['wizard.stepSubType.titleFirst']()}
    <span class="inner-text-special">{m['wizard.stepSubType.titleHighlight']()}</span>
    {m['wizard.stepSubType.titleSecond']()}
  </h1>
...
<div class="subtypes-grid">
  {#each projectSubTypesFreestyle as subtype}
    <div
