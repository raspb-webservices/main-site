<script lang="ts">
  ...
  import { projectSubTypesAi } from '$lib/configs/wizard-config';
...
<style lang="postcss">
  @reference '../../../../app.css';
  .step-header {
    @apply border-t-base-content/40 mt-0 mb-8 border-t pt-8 text-center md:border-t-0;
  ...
  .subtypes-grid {
    ...
    .service-card {
      @apply border-base-300/80 max-w-md border bg-base-100 transition-all duration-300 md:max-w-lg;
      &:hover {
