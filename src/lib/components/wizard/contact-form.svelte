  ...
  <div class="content-section">
    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
      ...
      <div class="form-control w-full">
        <label class="label" for="salutation">
          <span class="label-text font-semibold">{(m as unknown as Record<string, () => string>)['wizard_contactForm_fields_salutation_label']()}</span>
        </label>
        <select
          id="salutation"
        ...
        >
          <option value="">{(m as unknown as Record<string, () => string>)['wizard_contactForm_fields_salutation_placeholder']()}</option>
          <option value="Herr">{(m as unknown as Record<string, () => string>)['wizard_contactForm_fields_salutation_options_herr']()}</option>
          <option value="Frau">{(m as unknown as Record<string, () => string>)['wizard_contactForm_fields_salutation_options_frau']()}</option>
          <option value="Divers">{(m as unknown as Record<string, () => string>)['wizard_contactForm_fields_salutation_options_divers']()}</option>
        </select>
      </div>
      ...
      <div class="form-control w-full">
        <label class="label" for="company">
          <span class="label-text font-semibold">{(m as unknown as Record<string, () => string>)['wizard_contactForm_fields_company_label']()}</span>
        </label>
        <input
          type="text"
          id="company"
          ...
          placeholder={(m as unknown as Record<string, () => string>)['wizard_contactForm_fields_company_placeholder']()}
        />
      </div>
      ...
      <div class="form-control w-full">
        ...
        <input
          ...
          placeholder={(m as unknown as Record<string, () => string>)['wizard_contactForm_fields_givenName_placeholder']()}
          required
        />
      </div>
      ...
      <div class="form-control w-full">
        ...
        <input
          ...
          placeholder={(m as unknown as Record<string, () => string>)['wizard_contactForm_fields_familyName_placeholder']()}
          required
        />
      </div>
      ...
      <div class="form-control w-full md:col-span-2">
        ...
        <input
          ...
          placeholder={(m as unknown as Record<string, () => string>)['wizard_contactForm_fields_email_placeholder']()}
          required
        />
        {#if customerData.email && !isValidEmail(customerData.email)}
          <div class="label">
            <span class="label-text-alt text-error">{(m as unknown as Record<string, () => string>)['wizard_contactForm_fields_email_validation']()}</span>
          </div>
        {/if}
      </div>
      ...
      <div class="form-control w-full">
        <label class="label" for="phone">
          <span class="label-text font-semibold">{(m as unknown as Record<string, () => string>)['wizard_contactForm_fields_phone_label']()}</span>
        </label>
        <input
          type="tel"
          id="phone"
          ...
          placeholder={(m as unknown as Record<string, () => string>)['wizard_contactForm_fields_phone_placeholder']()}
        />
      </div>
      ...
      <div class="form-control w-full">
        <label class="label" for="address">
          <span class="label-text font-semibold">{(m as unknown as Record<string, () => string>)['wizard_contactForm_fields_address_label']()}</span>
        </label>
        <input
          type="text"
          id="address"
          ...
          placeholder={(m as unknown as Record<string, () => string>)['wizard_contactForm_fields_address_placeholder']()}
        />
      </div>
      ...
      <div class="form-control w-full">
        <label class="label" for="postCode">
          <span class="label-text font-semibold">{(m as unknown as Record<string, () => string>)['wizard_contactForm_fields_postCode_label']()}</span>
        </label>
        <input
          type="text"
          id="postCode"
          ...
          placeholder={(m as unknown as Record<string, () => string>)['wizard_contactForm_fields_postCode_placeholder']()}
          maxlength="5"
        />
      </div>
      ...
      <div class="form-control w-full">
        <label class="label" for="city">
          <span class="label-text font-semibold">{(m as unknown as Record<string, () => string>)['wizard_contactForm_fields_city_label']()}</span>
        </label>
        <input
          type="text"
          id="city"
          ...
          placeholder={(m as unknown as Record<string, () => string>)['wizard_contactForm_fields_city_placeholder']()}
        />
      </div>
      ...
      <div class="form-control w-full">
        <label class="label" for="country">
          <span class="label-text font-semibold">{(m as unknown as Record<string, () => string>)['wizard_contactForm_fields_country_label']()}</span>
        </label>
        <select
          id="country"
          class="select select-bordered w-full"
        ...
        >
          <option value="Deutschland">{(m as unknown as Record<string, () => string>)['wizard_contactForm_fields_country_options_deutschland']()}</option>
          <option value="Österreich">{(m as unknown as Record<string, () => string>)['wizard_contactForm_fields_country_options_oesterreich']()}</option>
          <option value="Schweiz">{(m as unknown as Record<string, () => string>)['wizard_contactForm_fields_country_options_schweiz']()}</option>
          <option value="Niederlande">{(m as unknown as Record<string, () => string>)['wizard_contactForm_fields_country_options_niederlande']()}</option>
          <option value="Belgien">{(m as unknown as Record<string, () => string>)['wizard_contactForm_fields_country_options_belgien']()}</option>
          <option value="Frankreich">{(m as unknown as Record<string, () => string>)['wizard_contactForm_fields_country_options_frankreich']()}</option>
          <option value="Italien">{(m as unknown as Record<string, () => string>)['wizard_contactForm_fields_country_options_italien']()}</option>
          <option value="Spanien">{(m as unknown as Record<string, () => string>)['wizard_contactForm_fields_country_options_spanien']()}</option>
          <option value="Polen">{(m as unknown as Record<string, () => string>)['wizard_contactForm_fields_country_options_polen']()}</option>
          <option value="Tschechien">{(m as unknown as Record<string, () => string>)['wizard_contactForm_fields_country_options_tschechien']()}</option>
          <option value="Andere">{(m as unknown as Record<string, () => string>)['wizard_contactForm_fields_country_options_andere']()}</option>
        </select>
      </div>
      ...
      <div class="form-control w-full md:col-span-2">
        ...
        <input
          ...
          placeholder={(m as unknown as Record<string, () => string>)['wizard_contactForm_fields_password_placeholder']()}
          required
        />
      ...
      <div class="form-control w-full md:col-span-2">
        ...
        <input
          ...
          placeholder={(m as unknown as Record<string, () => string>)['wizard_contactForm_fields_passwordConfirm_placeholder']()}
          required
        />
    ...
    <div class="mt-4">
      <p class="text-base-content/60 text-sm">
        ...
        {(m as unknown as Record<string, () => string>)['wizard_contactForm_requiredNote']()}
      </p>
    </div>
  </div>
</div>
