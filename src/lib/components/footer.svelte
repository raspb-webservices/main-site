  ...
  <div class="inner-box">
    ...
    <div class="controls-area">
      ...
      <label class="swap swap-rotate ml-4 hover:scale-105" for="dark-theme-checkbox">
        <input type="checkbox" class="theme-controller" id="dark-theme-checkbox" name="dark-theme-checkbox" bind:checked={darkActive} value="dark" onchange={updateDataAttribute} />
