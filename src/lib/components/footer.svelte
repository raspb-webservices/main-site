...
<style lang="postcss">
  ...
  footer {
    ...
    .inner-box {
      ...
      .final-row {
        @apply border-base-content-100 mt-6 flex w-full items-center justify-between border-t-2 py-6 pl-4 pr-2;
      }
    }
  }

  .locale-toggle-btn {
    @apply flex h-8 w-8 cursor-pointer items-center justify-center overflow-hidden rounded-full bg-base-50 bg-cover bg-center bg-no-repeat p-0 transition-all duration-300;
    &.german {
